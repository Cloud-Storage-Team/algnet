...
class BFSSwitch : public NetworkSwitch {
private:
...
public:
    BFSSwitch() = default;
    explicit BFSSwitch(std::uint64_t credit_rate_limit_ns, std::uint64_t process_time_ns = 0, std::uint8_t max_credit_buffer_size = 8);
