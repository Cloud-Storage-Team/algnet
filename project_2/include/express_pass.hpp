...
public:
    ...
    const static std::uint64_t default_inter_credit_gap_ns = (min_packet_size + default_data_size + target_link_speed - 1) / target_link_speed;
    const static std::uint64_t min_jitter = (default_inter_credit_gap_ns + 99) / 100;
