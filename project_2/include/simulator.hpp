...
private:
    ...
    /**
     * Creates direct and reverse link between two network elements with given speed (in bits per ns)
     *
     * Do not forget to initialize corresponding routing tables after creating new connection
     */
