...
public:
    ...
    static inline std::map<std::pair<std::uint32_t, std::uint32_t>, std::shared_ptr<Link>> forward_routing_table;
    static inline std::map<std::pair<std::uint32_t, std::uint32_t>, std::shared_ptr<Link>> backward_routing_table;
