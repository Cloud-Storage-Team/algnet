...
2. Add implementation of parsing for `YourCC` to [parsing file](source/parser/simulator/flow/parse_tcp_flow.cpp).
...
2. Add implementation for `Parser<YourFlow>::parse_object`. This function should parse `YourFlow` from yaml file. See [implementation](source/parser/simulator/flow/parse_tcp_flow.cpp) for `TcpFlow`
3. Create configuration files for testing and running your algorithm. See [simulation config](configuration_examples/simulation_examples/tcp_simulation.yml) for `TcpTahoe` algorithm. 
