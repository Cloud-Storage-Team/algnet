...
2. Add implementation of parsing for `YourCC` to [parsing file](source/parser/simulation/connection/flow/tcp_flow_parser.cpp) and call it from `parse_i_tcp_cc`.
