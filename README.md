...
2. Add implementation of parsing for `YourCC` to [parsing file](source/parser/simulation/flow/tcp_flow_parser.cpp).
...
2. Add implementation for `Parser<YourFlow>::parse_object`. This function should parse `YourFlow` from yaml file. See [implementation](source/parser/simulation/flow/tcp_flow_parser.cpp) for `TcpFlow`
3. Create configuration files for testing and running your algorithm. See [simulation config](configuration_examples/simulation_examples/tcp_simulation.yml) for `TcpTahoe` algorithm. 
