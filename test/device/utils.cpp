...
bool TestRoutingModule::check_route(std::shared_ptr<sim::IRoutingDevice> device, std::shared_ptr<sim::Link> link) {
...
TestLink::TestLink(std::shared_ptr<sim::IRoutingDevice> a_src, std::shared_ptr<sim::IRoutingDevice> a_dest)
